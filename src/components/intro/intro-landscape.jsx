...
export function IntroLandscape() {
  ...
  return (
    <View style={styles.wrap} pointerEvents="none">
      ...
      <Cloud style={styles.cloudOne} styles={styles} />
      <Cloud style={styles.cloudTwo} styles={styles} />
      <Bird styles={styles} />

      <View style={styles.scene}>
        <Cactus styles={styles} />
        <Church styles={styles} />
      </View>
...
function makeStyles(c) {
  return {
    ...
    wave: {
      ...
      height: 18,
      borderBottomWidth: 2,
      borderBottomColor: c.landscapeBlue,
      borderRadius: 40,
    },
    waveTwo: {
      top: 38,
